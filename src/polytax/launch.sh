...
for i in $(seq 1 $(($NUMNODES-1))); do
  ...
  gcloud alpha compute tpus tpu-vm ssh $NODENAME --zone us-central1-f --command "cd ~/; git clone https://github.com/mweiss17/polytax.git; cd polytax; ./launch_tpu.sh  $i"
